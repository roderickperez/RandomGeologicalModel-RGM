...
!
function split_list_int(list, nc, index) result(c)
    ! arguments
...
!> and get a specific chunck by index
!
function split_list_float(list, nc, index) result(c)
    ! arguments
...
!> and get a specific chunck by index
!
function split_list_double(list, nc, index) result(c)
    ! arguments
    ...
    call cut(1, n, nc, irange)
    c = list(irange(index, 1):irange(index, 2))
end function split_list_double
!
! © 2024. Triad National Security, LLC. All rights reserved.
!
! This program was produced under U.S. Government contract 89233218CNA000001
...
!> and get a specific chunck by index
!
function split_list_complex(list, nc, index) result(c)
    ! arguments
    ...
    call cut(1, n, nc, irange)
    c = list(irange(index, 1):irange(index, 2))
end function split_list_complex
!
! © 2024. Triad National Security, LLC. All rights reserved.
!
! This program was produced under U.S. Government contract 89233218CNA000001
...
!> and get a specific chunck by index
!
function split_list_dcomplex(list, nc, index) result(c)
    ! arguments
    double complex, dimension(:), intent(in) :: list
    integer, intent(in) :: nc
    integer, intent(in) :: index
    ...
    call cut(1, n, nc, irange)
    c = list(irange(index, 1):irange(index, 2))
end function split_list_dcomplex
!
! © 2024. Triad National Security, LLC. All rights reserved.
!
! This program was produced under U.S. Government contract 89233218CNA000001
...
!> and get a specific chunck by index
!
function split_list_logical(list, nc, index) result(c)
    ! arguments
    ...
    call cut(1, n, nc, irange)
    c = list(irange(index, 1):irange(index, 2))
end function split_list_logical
