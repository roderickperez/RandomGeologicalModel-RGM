...
! Kai Gao, kaigao@lanl.gov
!
function mean_filt_1d_float(w, nw) result(wr)
    ...
    allocate(wr(1:n1))
    do i = 1, n1
        wr(i) = mean(w(max(1, i - nw1):min(n1, i + nw1)))
    end do
end function mean_filt_1d_float
function mean_filt_2d_float(w, nw) result(wr)
    real, dimension(:, :), intent(in) :: w
    ...
    do j = 1, n2
        do i = 1, n1
            wr(i, j) = mean(w(max(1, i - nw1):min(n1, i + nw1), &
                max(1, j - nw2):min(n2, j + nw2)))
        end do
    end do
    !$omp end parallel do
end function mean_filt_2d_float
function mean_filt_3d_float(w, nw) result(wr)
    real, dimension(:, :, :), intent(in) :: w
    integer, dimension(:), intent(in), optional :: nw
    ...
    !$omp end parallel do
end function mean_filt_3d_float
!
! © 2024. Triad National Security, LLC. All rights reserved.
!
! This program was produced under U.S. Government contract 89233218CNA000001
...
! Kai Gao, kaigao@lanl.gov
!
function mean_filt_1d_double(w, nw) result(wr)
...
end function mean_filt_1d_double
function mean_filt_2d_double(w, nw) result(wr)
    double precision, dimension(:, :), intent(in) :: w
    integer, dimension(:), intent(in), optional :: nw
    integer :: i, j, n1, n2, nw1, nw2
    double precision, allocatable, dimension(:, :) :: wr
    ...
    !$omp end parallel do
end function mean_filt_2d_double
function mean_filt_3d_double(w, nw) result(wr)
    double precision, dimension(:, :, :), intent(in) :: w
    integer, dimension(:), intent(in), optional :: nw
    integer :: i, j, k, n1, n2, n3, nw1, nw2, nw3
    double precision, allocatable, dimension(:, :, :) :: wr
    ...
    !$omp end parallel do
end function mean_filt_3d_double
!
! © 2024. Triad National Security, LLC. All rights reserved.
!
! This program was produced under U.S. Government contract 89233218CNA000001
...
! Kai Gao, kaigao@lanl.gov
!
function mean_filt_1d_complex(w, nw) result(wr)
...
end function mean_filt_1d_complex
function mean_filt_2d_complex(w, nw) result(wr)
    complex, dimension(:, :), intent(in) :: w
    integer, dimension(:), intent(in), optional :: nw
    integer :: i, j, n1, n2, nw1, nw2
    complex, allocatable, dimension(:, :) :: wr
    ...
    !$omp end parallel do
end function mean_filt_2d_complex
function mean_filt_3d_complex(w, nw) result(wr)
    complex, dimension(:, :, :), intent(in) :: w
    integer, dimension(:), intent(in), optional :: nw
    integer :: i, j, k, n1, n2, n3, nw1, nw2, nw3
    complex, allocatable, dimension(:, :, :) :: wr
    ...
    !$omp end parallel do
end function mean_filt_3d_complex
!
! © 2024. Triad National Security, LLC. All rights reserved.
!
! This program was produced under U.S. Government contract 89233218CNA000001
...
! Kai Gao, kaigao@lanl.gov
!
function mean_filt_1d_dcomplex(w, nw) result(wr)
...
end function mean_filt_1d_dcomplex
function mean_filt_2d_dcomplex(w, nw) result(wr)
    double complex, dimension(:, :), intent(in) :: w
    integer, dimension(:), intent(in), optional :: nw
    integer :: i, j, n1, n2, nw1, nw2
    double complex, allocatable, dimension(:, :) :: wr
    ...
    !$omp end parallel do
end function mean_filt_2d_dcomplex
function mean_filt_3d_dcomplex(w, nw) result(wr)
    double complex, dimension(:, :, :), intent(in) :: w
    integer, dimension(:), intent(in), optional :: nw
    integer :: i, j, k, n1, n2, n3, nw1, nw2, nw3
    double complex, allocatable, dimension(:, :, :) :: wr
    ...
    !$omp end parallel do
end function mean_filt_3d_dcomplex
